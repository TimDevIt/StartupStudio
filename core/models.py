...
class EventType(models.Model):
    event_type_name = models.CharField(max_length=50, unique=True)
...
class Skill(models.Model):
    skill_name = models.CharField(max_length=80, unique=True)
    skill_info = models.CharField(max_length=800, blank=True)
    direction = models.ForeignKey(Direction, on_delete=models.CASCADE, null=True,default=None)
    def __str__(self):
...
class Project(models.Model):
    ...
    class Meta:
        permissions = [
            ...
            ("can_enter_projects", "Can enter projects"),
            ("can_view_project_details", "Can view project details"),
        ]
